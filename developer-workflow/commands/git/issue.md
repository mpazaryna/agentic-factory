---
description: Fetch GitHub issue details and load into context for analysis and implementation.
...
- Format is optimized for implementing the requested changes.
