---
name: orchestra-plan
description: "Planning conductor — runs the full PRD → Spec → Gherkin loop in a single interactive session with human approval gates. Use when starting new work from a ticket or brief, or resuming an in-progress planning session."
