---
name: orchestra-uml
description: "Generate UML diagrams as Mermaid code and save them to .orchestra/uml/. Supports sequence, class, deployment, component, and state diagram types. Use when documenting system architecture, agent workflows, deployment topology, or state machines."
