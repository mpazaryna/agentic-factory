...
description: "Orient at session start — read project state, surface what needs attention, and route to the right skill. Use when starting a work session, when unsure what to work on next, or any time a current read of project state is needed."
