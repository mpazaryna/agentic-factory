...
**Creates**:
```
.orchestra/decisions/{NNN}-{decision-name}.md
```

**Process**:
1. Find next ADR number (glob `.orchestra/decisions/*.md`, or start at 001)
2. Create `.orchestra/decisions/` directory if needed
...
| Design docs per feature | Only major systems need design docs | `docs/architecture/` for systems |
