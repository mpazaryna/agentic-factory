...
Monk runs the daily rhythm -- kickoff in the morning, shutdown in the evening -- without stopping to ask questions. He reads the kairos skills (kickoff, shutdown, knote) as his subject matter expertise, then performs.
...
/kairos:knote                # Quick thought capture
```
