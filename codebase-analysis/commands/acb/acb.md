...
2. **Load base analysis template** from `templates/acb/base.md` (relative to this command)
...
**Base Template**: Always include `templates/acb/base.md`

**Technology Templates** (include if detected):
- MCP Server → `templates/acb/mcp-server.md`
- Next.js → `templates/acb/nextjs.md`
- Cloudflare Workers → `templates/acb/cloudflare-worker.md`
- TypeScript → `templates/acb/typescript.md`
- Jest → `templates/acb/jest-testing.md`
- iOS → `templates/acb/ios-swift.md`
- Android → `templates/acb/android-kotlin.md`
